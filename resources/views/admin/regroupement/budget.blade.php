        ...
        <a id="lien" class="btn btn-primary " style="margin-left: 10px;" href="{{ route('prevision')}}"> <i class="fa fa-angle-left"></i> Retour</a>
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <div class="table-head">
                    <h4><i class="fa fa-angle-right"></i>Budgets | <span>{{$regio->nom_region}}</span> | <span>{{$annee}}</span></h4>
                    <a target="blank" href="{{ route('exportPdfgroupeBudget')}}?annee={{Crypt::encrypt($annee)}}&region={{Crypt::encrypt($region)}}" class="btn btn-danger"><i class="fas fa-file-pdf"></i> Télécharger</a>
                </div>
