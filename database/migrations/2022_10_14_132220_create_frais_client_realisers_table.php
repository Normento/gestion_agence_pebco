...
class CreateFraisClientRealisersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('frais_client_realisers', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_id');
            $table->string('code_agence');
            $table->foreignId('frais_client_id');
    ...
    {
        Schema::dropIfExists('frais_client_realisers');
    }
}
